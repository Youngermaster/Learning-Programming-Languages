...
int main(){
	...
	cout<<endl<<endl<<"Antes del intercambio."<<endl;
	cout<<endl<<"\tEl numero 1 es: "<<num1;
	cout<<endl<<"\tEl numero 2 es: "<<num2;
	
	intercambio(&num1, &num2);
	
	cout<<endl<<endl<<"Despues del intercambio."<<endl;
	cout<<endl<<"\tEl numero 1 es: "<<num1;
	cout<<endl<<"\tEl numero 2 es: "<<num2<<endl;
