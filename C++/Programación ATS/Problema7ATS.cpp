...
int main(){
	...
	cout<<"\nDigite el numero A por favor: "; cin>>A;
	cout<<"\nDigite el numero B por favor: "; cin>>B;
	cout<<"\nDigite el numero C por favor: "; cin>>C;
	cout<<"\nDigite el numero D por favor: "; cin>>D;
	cout<<"\nDigite el numero E por favor: "; cin>>E;
	cout<<"\nDigite el numero F por favor: "; cin>>F;
