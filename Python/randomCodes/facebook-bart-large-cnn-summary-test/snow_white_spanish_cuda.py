...
for chunk in chunks:
    ...
    #target_length = min(input_length // 2, target_max_length)  # Aim to halve the input or set to max of 500
    summary = smr_bart(chunk, max_length=target_max_length)[0]['summary_text']
